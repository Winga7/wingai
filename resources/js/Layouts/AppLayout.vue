                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('ia.personalization.index')" :active="route().current('ia.personalization.index')">
                                    Personnalisation IA
                                </NavLink>
                            </div>
                        </div>
                    ...
                    <div class="pt-5 pb-6 px-5">
                        ...
                        <div class="mt-6">
                            <nav class="grid gap-y-8">
                                ...
                                <ResponsiveNavLink :href="route('ask.index')" :active="route().current('ask.index')">
                                    Chat IA
                                </ResponsiveNavLink>
                                <ResponsiveNavLink :href="route('ia.personalization.index')" :active="route().current('ia.personalization.index')">
                                    Personnalisation IA
                                </ResponsiveNavLink>
                            </nav>
                        </div>
