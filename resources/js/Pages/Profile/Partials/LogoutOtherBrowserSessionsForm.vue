        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">
                    Déconnecter les sessions du navigateur
                </PrimaryButton>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Veuillez entrer votre mot de passe pour confirmer que vous souhaitez déconnecter vos sessions sur d'autres navigateurs et appareils.
